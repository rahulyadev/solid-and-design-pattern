...
|---|---|---|---|---|---|---|---|---|
| `SDP-FND-010` | [Design vocabulary: principle, pattern, idiom, framework, and architecture](CURRICULUM.md#sdp-fnd-010) | Core | Absent | Not started | — | — | — | — |
| `SDP-FND-020` | [Change pressure, responsibilities, and boundaries](CURRICULUM.md#sdp-fnd-020) | Core | Absent | Not started | — | — | — | — |
| `SDP-FND-030` | [Cohesion, coupling, and dependency direction](CURRICULUM.md#sdp-fnd-030) | Core | Absent | Not started | — | — | — | — |
...
| `SDP-SOL-060` | [SOLID interactions, tensions, and trade-offs](CURRICULUM.md#sdp-sol-060) | Core | Absent | Not started | — | — | — | — |
| `SDP-SOL-070` | [Pythonic SOLID with functions, modules, Protocols, and ABCs](CURRICULUM.md#sdp-sol-070) | Core | Absent | Not started | — | — | — | — |
| `SDP-SOL-080` | [SOLID critiques, overapplication, and legacy refactoring](CURRICULUM.md#sdp-sol-080) | Professional | Absent | Not started | — | — | — | — |
